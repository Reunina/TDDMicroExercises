...
class Alarm(object):
    ...
    def check(self):
        ...
        self.set_alarm_when_pressure_is_off(psi_pressure_value)

    def set_alarm_when_pressure_is_off(self, psi_pressure_value):
    ...
    @property
    def maximum_pressure_authorized(self):
        return int(self._high_pressure_threshold)
